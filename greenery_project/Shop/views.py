...
from Customer.models import CustomerDetails # type: ignore
from django.contrib import messages
from django.contrib.auth.decorators import login_required
from Cart.models import Orders, ProductOrders # type: ignore


# Create your views here.

def home(request):
    product = GreeneryProducts.objects.all()
...
def shop(request,link=None):
    if link is not None:
        ...
        paginator = Paginator(all_items,6) # show 9 items per page
